...
/**
 * MAGIC GLOVE V2 — Bright Premium + Specialty Sliders + Zip Checker + Testimonials
...
// Ensures nav scroll works even when you're on /community or /work/*
      ...
      <header className="nav">
        <div className="wrap navInner">
          ...
          <nav className="navLinks">
            <a href="#/" onClick={() => goHomeAndScroll("specialty")}>
              Specialty
            </a>
            <a href="#/" onClick={() => goHomeAndScroll("services")}>
              Services
            </a>
            <a href="#/" onClick={() => goHomeAndScroll("testimonials")}>
              Reviews
            </a>
            <a href="#/community">Community</a>
            <a href="#/" onClick={() => goHomeAndScroll("estimate")}>
              Estimate
            </a>
          </nav>
          ...
          <div className="navCtas">
            <Button
              variant="primary"
              href="#/"
              onClick={() => goHomeAndScroll("estimate")}
            >
              Get Free Estimate
            </Button>
        ...
        <div className="wrap footerInner">
          ...
          <div>
            ...
            <div className="footText">
              Honest work, fair pricing, and respect for every home and
        ...
        <div className="wrap heroInner">
          ...
          <div className="heroContent">
            ...
            <p className="heroLong">
              We don’t just clean windows — we show up for the neighborhoods we
              serve, because we live here too. We prioritize long-term
              relationships over one-time transactions. Clean windows are our
              foundation, and we’re not finished until you’re happy. While
              other companies chase shortcuts and pricing games, Magic Glove
              focuses on people. We treat your home like it’s our own —
            ...
            <div className="heroNote">
              Video background can be added later (drone shots, cleaning footage,
              etc.).
            </div>
          </div>
        </div>
          ...
          <div className="howGrid">
            <button className="howStep" onClick={() => scrollToId("estimate")} type="button">
              ...
              <div className="howText">
                Tell us what you need + where you’re located. Photos help for
                accuracy.
              </div>
            </button>
            ...
            <button className="howStep" onClick={() => scrollToId("estimate")} type="button">
              ...
              <div className="howText">
                We confirm details and set a clean, simple plan.
              </div>
            </button>
            ...
            <div className="cardPad seoPad">
              ...
              <div className="seoCta">
                <div className="seoCtaLine">
                  Want a clean, premium finish with fair pricing and real care?
                  Request a free quote anytime.
                </div>
        ...
        <div className="wrap">
          <div className="communityTop">
            ...
            <p className="communitySub">
              Magic Glove is about more than clean windows — it’s about
              strengthening communities, one home at a time.
            </p>
          ...
          <Card>
            <div className="cardPad longForm">
              ...
              <div className="lfP">
                We don’t just clean windows—we take pride in caring for the
              ...
              <div className="lfBlock">
                ...
                <div className="lfText">
                  Magic Glove Window Cleaning was created with the belief that
                  great work and strong community go hand in hand. We don’t just
                  clean windows—we take pride in caring for the neighborhoods we
                  serve.
                </div>
              </div>
              ...
              <div className="lfBlock">
                ...
                <div className="lfText">
                  Magic Glove Window Cleaning was founded on the belief that
                  taking care of a home is really about taking care of the
                  people who live there. Armando, the founder of Magic Glove,
                  was born and raised in Los Angeles, and his community has
                  always meant everything to him.
                </div>
                <div className="lfText">
                  He comes from a background of successful work with larger
                  corporate companies, where he learned discipline,
                  professionalism, and what it takes to build a reliable
                  operation—but he always felt disconnected from the people he
                  was meant to serve.
                </div>
                <div className="lfText">
                  What stayed with him most were the moments driving through the
                  neighborhoods he grew up in—seeing children play in yards
                  cluttered with broken fences, hearing neighbors talk about
                  struggling to keep up with bills or home repairs, and noticing
                  elderly residents working tirelessly to maintain their homes
                  despite limited resources.
                </div>
                <div className="lfText">
                  Witnessing these everyday challenges made him realize he
                  wanted to serve his community in a way that allowed him to
                  give his fullest and most authentic self. Although he didn’t
                  initially know what business to start, he realized that the
                  work he did in high school—cleaning windows, mowing lawns, and
                  helping neighbors maintain their homes—combined with the
                  skills and professionalism he gained from his corporate career,
                  gave him the perfect foundation to create something meaningful.
                </div>
                <div className="lfText">
                  That insight became the spark for Magic Glove Window Cleaning,
                  a business built to serve his community with care, reliability,
                  and pride in every job. Window cleaning is only the first
                  step—Magic Glove aims to grow into a one-stop, full-service
              ...
              <div className="lfBlock">
                ...
                <ol className="lfList">
                  <li>
                    ...
                    <br />
                    Every home and storefront is part of a larger community we
                    respect and care for.
                  </li>
                  <li>
                    <strong>Relationships Matter</strong>
                    <br />
                    We prioritize long-term relationships over one-time
                    transactions.
                  </li>
                  <li>
                    <strong>Pride in Our Craft</strong>
                    <br />
                    Clean windows are our foundation, and every job is done with
                    care and attention to detail.
                  </li>
                  <li>
                    <strong>Giving Back</strong>
                    <br />
                    As Magic Glove grows, so does our commitment to supporting
              ...
              <div className="lfCta">
                <div className="lfCtaLine">
                  Magic Glove Window Cleaning is about more than clean windows.
                  It’s about strengthening communities—one home at a time.
                </div>
              ...
              <div className="tiny">
                We can tighten this page later for SEO/readability if you want.
              </div>
            </div>
          </Card>
        </div>
      ...
      <Card className="formCard">
        <div className="cardPad">
          <form onSubmit={submit}>
            ...
            <p className="tiny">
              Demo note: We’ll wire this to your tools after design approval.
            </p>
          </form>
        </div>
      </Card>
...
export default function Page() {
  ...
  // (Optional) Work pages can be re-added next — keep home stable first
